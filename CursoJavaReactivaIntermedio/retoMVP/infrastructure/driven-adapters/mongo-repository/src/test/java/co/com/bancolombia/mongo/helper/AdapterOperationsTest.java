...
import co.com.bancolombia.mongo.MongoBoxRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    private MongoBoxRepositoryAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new MongoBoxRepositoryAdapter(repository, objectMapper);
