...
public class RouterRest {
    @Bean
    public RouterFunction<ServerResponse> boxFunctions(BoxHandler handler) {
    ...
    @Bean
    public RouterFunction<ServerResponse> movementFunctions(MovementHandler handler) {
        return route(POST("/api/boxes/{boxId}/movements/upload"), handler::uploadCSV);
    }
}
