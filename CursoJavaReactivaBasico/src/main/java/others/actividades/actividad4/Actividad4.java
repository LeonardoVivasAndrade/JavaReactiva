package others.actividades.actividad4;
...
public class Actividad4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nPunto 2:");
        fluxPersonas = fluxPersonas
                .map(persona -> {
                    if (persona.getEdad() == 0) {
                        throw new RuntimeException("Encountered an error processing element: " + persona.getNombre());
                    }
                    return persona;
                })
        ...
        //Manejo de error si la persona tiene edad 0
        fluxPersonas.doOnError(error -> {
        ...
        personasEdad
                .toStream()
                .peek(p -> {
                    System.out.println("Persona de edad " + p.getEdad() + ": " + p.getNombre());
                })
                .toList();
        ...
        personasSigno
                .toStream()
                .peek(p -> {
                    System.out.println("Persona de signo " + p.getSigno() + ": " + p.getNombre());
                })
                .toList();
